...
if __name__ == "__main__":
    ...
    model = ERNet(config=config).load_from_checkpoint('C:/Users/tm011/PycharmProjects/level2_klue-nlp-08/checkpoint/klue_roberta-large/2023-05-15 10.30.11/epoch=3-val_micro_f1=69.62.ckpt',config=config)

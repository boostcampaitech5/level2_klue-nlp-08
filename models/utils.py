...
from models.TAEMIN_TOKEN_ATTENTION_RoBERTa import TAEMIN_TOKEN_ATTENTION_RoBERTa_NER
...
def get_model(model_name : str, state=None):
    ...
    if model_name == "TAEMIN_TOKEN_ATTENTION_RoBERTa":
        model = TAEMIN_TOKEN_ATTENTION_RoBERTa_NER.from_pretrained("klue/roberta-large", state=state)

...
def tokenized_dataset_type_entity_token(dataset : pd.DataFrame, tokenizer: AutoTokenizer, tokenizer_max_len : int) -> Dict:
    ...
    new_sentences = []
    for sent, sub_s, sub_e, sub_type, obj_s, obj_e, obj_type in zip(dataset["sentence"], dataset["subject_start_idx"], dataset["subject_end_idx"], dataset["subject_entity_type"], dataset["object_start_idx"], dataset["object_end_idx"]):
